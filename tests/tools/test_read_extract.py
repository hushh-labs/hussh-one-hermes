...
class TestNotebookExtraction(unittest.TestCase):
    ...
    def test_byte_snapshot_extraction(self):
        ...
        self.assertIn(
            "Snapshot text", extract_document_bytes(payload, "snapshot.ipynb")
        )
...
class TestDocxExtraction(unittest.TestCase):
    ...
    def test_byte_snapshot_extraction(self):
        ...
        with open(p, "rb") as fh:
            self.assertIn("Snapshot DOCX", extract_document_bytes(fh.read(), p))
...
class TestXlsxExtraction(unittest.TestCase):
    ...
    def test_byte_snapshot_extraction(self):
        ...
        self._build(p)
        with open(p, "rb") as fh:
            text = extract_document_bytes(fh.read(), p)
