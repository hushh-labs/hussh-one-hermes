...
class TestResolverPlumbing:
    def test_posture_path_folds_in_the_session_surface(self, no_desktop_env):
        ...
        Desktop also folds in the Hussh One native-workstation toolset here
        (fork-owned overlay on top of the generic GUI surface — see
        ``_hussh_one_surface_toolsets``); it does not apply on ``tui``.
        """
