...
_HERMES_CORE_TOOLS = [
    ...
    # Native Hussh One owner action. Hidden unless the active profile is
    # enrolled; every call still requires an unlocked in-process vault and a
    # fresh, non-cacheable user approval.
    "save_to_pkm",
    # Cronjob management
    "cronjob",
