...
def switch_model(
    ...
    # =================================================================
        ...
        # A provider-qualified model (e.g. "openai/gpt-5") already resolved
        # target_provider/new_model above — skip MoA-preset and alias
        # resolution entirely so it can't be second-guessed by either.
        alias_result = None
        if not provider_prefix_resolved:
            try:
                from hermes_cli.config import load_config
        ...
        if resolved_moa_preset or provider_prefix_resolved:
            pass
