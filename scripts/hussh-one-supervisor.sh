...
DASHBOARD_MEM_CAP_GRACE_SECONDS="${HUSSH_ONE_DASHBOARD_MEM_CAP_GRACE_SECONDS:-900}"
...
<dict>
  ...
  <dict>
    ...
    <key>HUSSH_ONE_DASHBOARD_MEM_CAP_GRACE_SECONDS</key>
    <string>$(xml_escape "$DASHBOARD_MEM_CAP_GRACE_SECONDS")</string>
  </dict>
  <key>RunAtLoad</key>
  <true/>
  <key>KeepAlive</key>
