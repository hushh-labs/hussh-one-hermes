...
# Hushh-brand overrides layered onto the shared upstream defaults.
# config_defaults.py is a pure-data leaf module (must not import from this
# module), so the dynamic brand/theme/skin defaults are applied here instead.
DEFAULT_CONFIG["brand"] = default_brand_config()
DEFAULT_CONFIG["display"]["skin"] = default_display_skin()
DEFAULT_CONFIG["dashboard"]["theme"] = default_dashboard_theme()
